...
import { updateClub } from "../graphql/mutations";
...
export default function ClubUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setCityArea(cleanValues.cityArea);
    setContactEmail(cleanValues.contactEmail);
    setPhoneNumber(cleanValues.phoneNumber);
    setDescription(cleanValues.description);
    setRules(cleanValues.rules);
    setMemberLimit(cleanValues.memberLimit);
    setLogoUrl(cleanValues.logoUrl);
    setAdditionalImages(cleanValues.additionalImages ?? []);
    setCurrentAdditionalImagesValue("");
    setBannerImageUrl(cleanValues.bannerImageUrl);
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getClub.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getClub
        : clubModelProp;
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateClub.replaceAll("__typename", ""),
            variables: {
              input: {
                id: clubRecord.id,
                ...modelFields,
